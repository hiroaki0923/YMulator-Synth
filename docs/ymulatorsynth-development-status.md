...
- ✅ **MIDI CC マッピング修正** - オペレーターごとの 11 連番＋0〜127 スケーリングになっていたのを、VOPMex の一次資料どおり（パラメーターごとに 4 連番、値はレジスタ値、D1L 55-58 / RR 59-62 / AME 70-73 / LFO 1,2,3,12 / ノイズ 80,82）に修正。旧番号 76〜79、81 は互換維持。テスト `tests/unit/MidiCcMappingTest.cpp`
