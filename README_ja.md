...
| 1 | LFO 周波数 | 0-127 | 8 ビット LFRQ の上位 7 ビット（76 も受け付け） |
| 2 | LFO PMD | 0-127 | ピッチ変調深度（78 も受け付け） |
| 3 | LFO AMD | 0-127 | 振幅変調深度（77 も受け付け） |
| 12 | LFO 波形 | 0-3 | Saw / Square / Triangle / Noise（79 も受け付け） |
| 80 | ノイズ有効 | 0 / 1-127 | チャンネル 8 のノイズ |
| 82 | ノイズ周波数 | 0-31 | NFRQ（81 も受け付け） |

CC 値は VOPMex と同じくレジスタ値そのものです。TL は 0 が最大音量で 127 が無音、MUL は 0〜15、AR は 0〜31 などで、範囲を超える値は上限に丸められます。
